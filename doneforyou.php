...
<div class="container bg-light">
    <div class="row">
        ...
        <div class="col-md-6 p-4">
            <h2>Order for <span class="text-danger">Done For You</span> system:</h2>
            <?php
                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                   ...
                   if(!empty($_POST["fullname"]) && !empty($_POST["emailId"]) && !empty($_POST["niche"]) && !empty($_POST["exampleRadios"])) {
                       ...
                       $subject = "Some one opted for done-for-you";
                       ...
                       $replysubject = "Agile Affiliates Done-For-You Update!";
                       $replymsg = "The done-for-you link will be send to your email id soon! Please check your spam and promotion folder too!";
                       $replyheaders = "From: support@agileaffiliates.com";
                       
                       if(mail($to,$subject,$message,$headers)) {
                           mail($replyto, $replysubject, $replymsg, $replyheaders);
                        ?>
                        <h5 class="text-success">Email received! Done-for-you link will be sent to you soon!</h5>
                        <?php
                       } else {
                        ?>
                        <h5 class="text-damger">Email did not send</h5>
                        <?php
                       }
